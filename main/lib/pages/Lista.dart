...
class _ListaScreenState extends State<ListaScreen> {
  ...
  Future<void> _carregarListas() async {
    ...
    setState(() {
      listasFixadas = todasListas.where((lista) => lista['fixado'] == 1).toList();
      listasComuns = todasListas.where((lista) => lista['fixado'] == 0).toList();
    });
  }
              ...
              children: [
                ...
                Row(
                  children: [
                    IconButton(
                      icon: Icon(
                        lista['fixado'] == 1 ? Icons.push_pin : Icons.push_pin_outlined,
                        color: Colors.blue,
                      ),
                      onPressed: () => _fixarLista(lista['id'], lista['fixado'] != 1),
                    ),
                    IconButton(
      ...
      body: listasFixadas.isEmpty && listasComuns.isEmpty
        ...
        children: [
          if (listasFixadas.isNotEmpty) ...[
            ...
            ...listasFixadas.map((lista) => _buildListaItem(lista)).toList(),
          ],
          if (listasComuns.isNotEmpty) ...[
            ...
            ...listasComuns.map((lista) => _buildListaItem(lista)).toList(),
          ],
        ],
      ),
