  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        preferredSize: const Size.fromHeight(120), // Altura maior da AppBar
        child: AppBar(
          backgroundColor: Colors.red.shade700, // Cor de fundo vermelha
          elevation: 0, // Retira a sombra da barra
          flexibleSpace: Padding(
            padding:
                const EdgeInsets.only(top: 40.0), // Ajuste a altura do ícone
            child: Center(
              child: Image.asset(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const SizedBox(
                height: 100), // Espaço adicional para a margem superior
            ...
            const SizedBox(height: 5), // Menor espaço entre os textos
            const Text(
            ...
            SizedBox(
              width:
                  double.infinity, // Garante que o botão ocupe toda a largura
